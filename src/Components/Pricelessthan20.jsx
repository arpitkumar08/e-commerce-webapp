...
const Pricelessthan20 = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filtered = result.filter((product) => product.price < 20);
    ...
    return (
        <div className="px-4 py-6 sm:px-6 bg-gray-100">
            ...
            ) : productsUnder20.length === 0 ? (
                <p className="text-center text-red-500">No products found under $20.</p>
            ) : (
                <div className="overflow-x-auto scrollbar-hide">
                    <div className="flex gap-4 w-max px-1 cursor-pointer">
...
export default Pricelessthan20;
